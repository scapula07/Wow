...
import { createClip, type ClipPayload } from "./actions";
  ...
  return (
    <Player.Root src={props.src}>
      <Player.Container className="h-full w-full overflow-hidden bg-black outline-none transition">
        ...
        <Player.Controls 
          autoHide={0}
          className="bg-gradient-to-b gap-1 px-3 md:px-3 py-2 flex-col-reverse flex from-black/5 via-80% via-black/30 to-black/60 !opacity-100 !visible"
        >
